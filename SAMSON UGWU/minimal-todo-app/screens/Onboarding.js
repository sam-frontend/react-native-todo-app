...
export default function Onboarding() {
    ...
    return(
        <View style={styles.container}>
            <Text style={styles.title}>Welcome to Sam-ToDo-App</Text>
            <View style={styles.featureContainer}>
                <Image style={styles.icon} source={require('../assets/arrows.png')} />
                <View style={{flex: 1}}>
                    <Text style={styles.subTitle}>Manage Daily Tasks On Easybuy</Text>
                    <Text style={styles.subHeadline}>EASYBUY is a simple app that helps you to increase your profit.</Text>
                </View>
            </View>
            <View style={styles.featureContainer}>
            ...
            <View style={styles.featureContainer}>
                ...
                <View style={{flex: 1}}>
                    <Text style={styles.subTitle}>Easybuy Design</Text>
